...
export {profilePopout, deleteInput, avatar, avatarFormElement, 
  nameInput, deletePopout, avatarPopout, avatarLink, avatarEdit, 
  jobInput, profileFormElement, editBtn, addButton, galleryPopout, 
  galleryFormElement, titleInput, imageInput, galleryContainer, 
  picturePopout, defaultConfig, escKeyCode}